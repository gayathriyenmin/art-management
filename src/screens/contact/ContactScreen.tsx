...
export const ContactScreen: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us |   Academy</title>
        <meta name="description" content="Reach out to   Academy admissions office. Send queries regarding curricula, studio reservations, or campus tours." />
      </Helmet>

      {/* Header Banner */}
      <Header
        title="Get in Touch"
        subtitle="Have questions about admissions, studio requirements, or scholarship tours? Send us a message or visit our campus."
      />
