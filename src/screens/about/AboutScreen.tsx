...
import { Timeline, Newsletter } from '../../components/sections';
  ...
  return (
    <>
      ...
      <Header
        ...
        subtitle="A luxury sanctuary for artists to hone classical skills and cultivate contemporary digital vision."
      />
      ...
      <section className="py-20 bg-bg-base">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <SectionTitle
            badge="Studio Mentors"
            title="Meet Our Masters"
            subtitle="Our instructors are active industry players, internationally recognized painters, and sculpting scholars."
          />
...
const ReactHelmetCheck = () => (
  <Helmet>
    <title>About Us |   Academy</title>
    <meta name="description" content="Discover the origins, values, and pedagogical philosophy behind   Academy's premium traditional and digital art curricula." />
  </Helmet>
);
