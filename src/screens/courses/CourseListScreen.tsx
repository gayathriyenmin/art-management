...
export const CourseListScreen: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Courses Curriculum |   Academy</title>
        <meta name="description" content="Explore our premium classical oil painting, digital illustration, and ceramic clay sculpting masterclasses." />
      </Helmet>
      ...
      <section className="py-16 md:py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          {/* Controls Bar */}
          <div className="flex flex-col lg:flex-row gap-6 items-stretch lg:items-center justify-between mb-12 border-b border-border-color pb-8 text-left">
            {/* Search Input */}
